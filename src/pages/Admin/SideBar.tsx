  ...
  return (
    <div className="fixed h-screen border-none bg-[#B3D7FF] md:block">
      ...
      <div className="fixed bottom-0 left-0 flex h-16 w-full items-center justify-around border-none bg-[#B3D7FF] md:relative md:h-screen md:flex-col md:justify-start  md:gap-10 lg:space-y-0">
        ...
        <Link
          to="/profile"
          className={`relative flex items-center space-x-4 rounded-md px-4 py-3 text-lg transition duration-300 ease-in-out ${
            activeLink === "/profile"
        ...
        >
          ...
          <span className="font-bold">我的帳戶</span>
        </Link>
        <Link
          to="/taskManagement"
          className={`relative flex items-center space-x-4 rounded-md px-4 py-3 text-lg text-[#3178C6] transition duration-300 ease-in-out hover:bg-[#3178C6] hover:text-white ${
        ...
        >
          ...
          <span className="font-bold">任務管理</span>
        </Link>
        <Link
          to="/reviewLists"
          className="relative flex items-center space-x-4 rounded-md px-4 py-3 text-lg text-[#3178C6] transition duration-300 ease-in-out hover:bg-[#3178C6] hover:text-white"
        >
          ...
          <span className="font-bold">我的評價</span>
        </Link>
        <Link
          to="/"
          className="relative flex items-center space-x-4 rounded-md px-4 py-3 text-lg text-[#3178C6] transition duration-300 ease-in-out hover:bg-[#3178C6] hover:text-white"
